...
export const functions = {
  ...
  EPDFPage_RemoveAnnotByName: [['number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFPage_RemoveAnnotRaw: [['number', 'number', 'number', 'number'] as const, 'boolean'] as const,
  EPDFRevision_Compare: [['number', 'number', 'number'] as const, 'number'] as const,
  EPDFRevision_Get: [['number', 'number'] as const, 'number'] as const,
  EPDFRevision_GetCount: [['number'] as const, 'number'] as const,
  EPDFRevision_GetFileEnd: [['number', 'number'] as const, 'boolean'] as const,
  EPDFRevision_GetSignature: [['number', 'number'] as const, 'number'] as const,
  EPDFRevisionDiff_Close: [['number'] as const, null] as const,
  EPDFRevisionDiff_GetEntry: [
    ['number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
  EPDFRevisionDiff_GetEntryCount: [['number'] as const, 'number'] as const,
  EPDFRevisionDiff_GetResolvedEntry: [
    ['number', 'number', 'number', 'number', 'number', 'number', 'number', 'number'] as const,
    'boolean',
  ] as const,
  EPDFRevisionDiff_GetResolvedEntryCount: [['number', 'number'] as const, 'number'] as const,
  EPDFRevisionDiff_GetSemanticCategoryCounts: [
    ['number', 'number', 'number', 'number', 'number'] as const,
    'number',
  ] as const,
  EPDFSig_CheckDocMDPCompliance: [['number', 'number'] as const, 'number'] as const,
  ...
  EPDFSig_GetSignatureRevision: [['number', 'number'] as const, 'number'] as const,
