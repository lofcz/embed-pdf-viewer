...
var _EPDF_FixPageFieldsRaw = Module['_EPDF_FixPageFieldsRaw'] = createExportWrapper('EPDF_FixPageFieldsRaw', 3);
var _EPDF_OpenFormFillInfo = Module['_EPDF_OpenFormFillInfo'] = createExportWrapper('EPDF_OpenFormFillInfo', 0);
var _EPDF_CloseFormFillInfo = Module['_EPDF_CloseFormFillInfo'] = createExportWrapper('EPDF_CloseFormFillInfo', 1);
...
var _EPDFRevision_GetCount = Module['_EPDFRevision_GetCount'] = createExportWrapper('EPDFRevision_GetCount', 1);
var _EPDFRevision_Get = Module['_EPDFRevision_Get'] = createExportWrapper('EPDFRevision_Get', 2);
var _EPDFRevision_GetFileEnd = Module['_EPDFRevision_GetFileEnd'] = createExportWrapper('EPDFRevision_GetFileEnd', 2);
var _EPDFRevision_Compare = Module['_EPDFRevision_Compare'] = createExportWrapper('EPDFRevision_Compare', 3);
var _EPDFRevisionDiff_Close = Module['_EPDFRevisionDiff_Close'] = createExportWrapper('EPDFRevisionDiff_Close', 1);
var _EPDFRevisionDiff_GetEntryCount = Module['_EPDFRevisionDiff_GetEntryCount'] = createExportWrapper('EPDFRevisionDiff_GetEntryCount', 1);
var _EPDFRevisionDiff_GetEntry = Module['_EPDFRevisionDiff_GetEntry'] = createExportWrapper('EPDFRevisionDiff_GetEntry', 4);
var _EPDFRevisionDiff_GetSemanticCategoryCounts = Module['_EPDFRevisionDiff_GetSemanticCategoryCounts'] = createExportWrapper('EPDFRevisionDiff_GetSemanticCategoryCounts', 5);
var _EPDFRevisionDiff_GetResolvedEntryCount = Module['_EPDFRevisionDiff_GetResolvedEntryCount'] = createExportWrapper('EPDFRevisionDiff_GetResolvedEntryCount', 2);
var _EPDFRevisionDiff_GetResolvedEntry = Module['_EPDFRevisionDiff_GetResolvedEntry'] = createExportWrapper('EPDFRevisionDiff_GetResolvedEntry', 8);
var _FPDF_SaveWithVersion = Module['_FPDF_SaveWithVersion'] = createExportWrapper('FPDF_SaveWithVersion', 4);
var _EPDF_SaveDocumentToBuffer = Module['_EPDF_SaveDocumentToBuffer'] = createExportWrapper('EPDF_SaveDocumentToBuffer', 3);
var _EPDF_SaveDocumentToBufferWithVersion = Module['_EPDF_SaveDocumentToBufferWithVersion'] = createExportWrapper('EPDF_SaveDocumentToBufferWithVersion', 4);
...
var _EPDFSig_PrepareSignatureDict = Module['_EPDFSig_PrepareSignatureDict'] = createExportWrapper('EPDFSig_PrepareSignatureDict', 3);
var _EPDFSig_SetReason = Module['_EPDFSig_SetReason'] = createExportWrapper('EPDFSig_SetReason', 2);
var _EPDFSig_SetLocation = Module['_EPDFSig_SetLocation'] = createExportWrapper('EPDFSig_SetLocation', 2);
var _EPDFSig_SetContactInfo = Module['_EPDFSig_SetContactInfo'] = createExportWrapper('EPDFSig_SetContactInfo', 2);
var _EPDFSig_SetDocMDP = Module['_EPDFSig_SetDocMDP'] = createExportWrapper('EPDFSig_SetDocMDP', 3);
var _EPDFSig_GetLocation = Module['_EPDFSig_GetLocation'] = createExportWrapper('EPDFSig_GetLocation', 3);
var _EPDFSig_GetContactInfo = Module['_EPDFSig_GetContactInfo'] = createExportWrapper('EPDFSig_GetContactInfo', 3);
var _EPDFSig_GetAnnotSignatureHandle = Module['_EPDFSig_GetAnnotSignatureHandle'] = createExportWrapper('EPDFSig_GetAnnotSignatureHandle', 1);
var _EPDFRevision_GetSignature = Module['_EPDFRevision_GetSignature'] = createExportWrapper('EPDFRevision_GetSignature', 2);
var _EPDFSig_GetSignatureRevision = Module['_EPDFSig_GetSignatureRevision'] = createExportWrapper('EPDFSig_GetSignatureRevision', 2);
var _EPDFSig_CheckDocMDPCompliance = Module['_EPDFSig_CheckDocMDPCompliance'] = createExportWrapper('EPDFSig_CheckDocMDPCompliance', 2);
