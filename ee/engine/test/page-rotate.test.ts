...
const TENANT_ID = 'cloud-page-rotate-tenant';
const DOC_ID = 'sample-pdf-page-rotate-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({ secret: 'cloud-page-rotate-conformance-secret' });
