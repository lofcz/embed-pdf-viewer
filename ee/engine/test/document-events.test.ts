...
const TENANT_ID = 'cloud-document-events-tenant';
const DOC_ID = 'sample-pdf-document-events-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({ secret: 'cloud-document-events-conformance-secret' });
...
runDocumentEventsConformance(runner, {
