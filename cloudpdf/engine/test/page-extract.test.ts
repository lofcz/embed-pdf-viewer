...
const TENANT_ID = 'cloud-page-extract-tenant';
const DOC_ID = 'sample-pdf-page-extract-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({ secret: 'cloud-page-extract-conformance-secret' });
