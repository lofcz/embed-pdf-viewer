...
const TENANT_ID = 'cloud-page-insert-blank-tenant';
const DOC_ID = 'sample-pdf-page-insert-blank-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({ secret: 'cloud-page-insert-blank-conformance-secret' });
...
runPageInsertBlankConformance(runner, {
