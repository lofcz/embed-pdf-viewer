...
CREATE TABLE base_versions (
  ...
  attachments_version BIGINT NOT NULL DEFAULT 1,
  annotations_version BIGINT NOT NULL DEFAULT 1,
...
CREATE TABLE document_signings (
  ...
  expected_layer_version BIGINT NOT NULL,
  base_byte_length       BIGINT NOT NULL,
  tail_key               TEXT    NOT NULL,
  tail_sha               TEXT    NOT NULL,
  tail_size              BIGINT NOT NULL,
  field_object_number    BIGINT NOT NULL,
