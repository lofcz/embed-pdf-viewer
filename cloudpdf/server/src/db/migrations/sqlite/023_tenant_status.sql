-- Tenant suspension (SQLite): the operator's circuit breaker. A stated
-- decision the engine enforces mechanically — every tenant JWT, doc
-- JWT, and share exchange for a suspended tenant fails 403 until
