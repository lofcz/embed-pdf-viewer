...
export class DeploymentClient {
    ...
    ): core.HttpResponsePromise<CloudPDF.DeploymentLicenseStatusResponse> {
        return core.HttpResponsePromise.fromPromise(this.__licenseStatus(requestOptions));
    }

    private async __licenseStatus(
        requestOptions?: DeploymentClient.RequestOptions,
    ): Promise<core.WithRawResponse<CloudPDF.DeploymentLicenseStatusResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as CloudPDF.DeploymentLicenseStatusResponse,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/deployment/license/status");
    }
}
