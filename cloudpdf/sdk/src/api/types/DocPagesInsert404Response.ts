...
export interface DocPagesInsert404Response {
    name: DocPagesInsert404Response.Name;
    code: DocPagesInsert404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesInsert404Response {
    export const Name = {
