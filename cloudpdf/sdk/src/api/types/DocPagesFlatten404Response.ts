...
export interface DocPagesFlatten404Response {
    name: DocPagesFlatten404Response.Name;
    code: DocPagesFlatten404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesFlatten404Response {
    export const Name = {
