...
export interface DocVersionsDownloadResponse {
    name: DocVersionsDownloadResponse.Name;
    code: DocVersionsDownloadResponse.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsDownloadResponse {
    export const Name = {
