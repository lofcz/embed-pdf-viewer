...
export interface DocAnnotationsListAll404Response {
    name: DocAnnotationsListAll404Response.Name;
    code: DocAnnotationsListAll404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsListAll404Response {
    export const Name = {
