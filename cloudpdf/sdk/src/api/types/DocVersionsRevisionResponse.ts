...
export interface DocVersionsRevisionResponse {
    name: DocVersionsRevisionResponse.Name;
    code: DocVersionsRevisionResponse.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsRevisionResponse {
    export const Name = {
