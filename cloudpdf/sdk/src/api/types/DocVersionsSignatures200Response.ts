...
export interface DocVersionsSignatures200Response {
    chainValid: boolean;
    revisions: DocVersionsSignatures200Response.Revisions.Item[];
    signatures: DocVersionsSignatures200Response.Signatures.Item[];
    protection: DocVersionsSignatures200Response.Protection;
}

export namespace DocVersionsSignatures200Response {
