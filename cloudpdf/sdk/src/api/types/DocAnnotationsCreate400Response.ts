...
export interface DocAnnotationsCreate400Response {
    name: DocAnnotationsCreate400Response.Name;
    code: DocAnnotationsCreate400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsCreate400Response {
    export const Name = {
