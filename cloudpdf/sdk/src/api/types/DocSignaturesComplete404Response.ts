...
export interface DocSignaturesComplete404Response {
    name: DocSignaturesComplete404Response.Name;
    code: DocSignaturesComplete404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesComplete404Response {
    export const Name = {
