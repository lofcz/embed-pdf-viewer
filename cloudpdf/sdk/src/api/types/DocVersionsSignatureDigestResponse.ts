...
export interface DocVersionsSignatureDigestResponse {
    name: DocVersionsSignatureDigestResponse.Name;
    code: DocVersionsSignatureDigestResponse.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsSignatureDigestResponse {
    export const Name = {
