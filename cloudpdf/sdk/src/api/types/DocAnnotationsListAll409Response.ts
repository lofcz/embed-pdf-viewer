...
export interface DocAnnotationsListAll409Response {
    name: DocAnnotationsListAll409Response.Name;
    code: DocAnnotationsListAll409Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsListAll409Response {
    export const Name = {
