...
export interface DocRedactionsApply404Response {
    name: DocRedactionsApply404Response.Name;
    code: DocRedactionsApply404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocRedactionsApply404Response {
    export const Name = {
