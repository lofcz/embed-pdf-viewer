...
export interface DocPagesExtract400Response {
    name: DocPagesExtract400Response.Name;
    code: DocPagesExtract400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesExtract400Response {
    export const Name = {
