...
export interface DocPagesInsert400Response {
    name: DocPagesInsert400Response.Name;
    code: DocPagesInsert400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesInsert400Response {
    export const Name = {
