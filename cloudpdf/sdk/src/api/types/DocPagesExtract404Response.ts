...
export interface DocPagesExtract404Response {
    name: DocPagesExtract404Response.Name;
    code: DocPagesExtract404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesExtract404Response {
    export const Name = {
