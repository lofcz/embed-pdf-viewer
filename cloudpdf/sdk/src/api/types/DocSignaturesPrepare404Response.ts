...
export interface DocSignaturesPrepare404Response {
    name: DocSignaturesPrepare404Response.Name;
    code: DocSignaturesPrepare404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesPrepare404Response {
    export const Name = {
