...
export interface DocPagesRotate404Response {
    name: DocPagesRotate404Response.Name;
    code: DocPagesRotate404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesRotate404Response {
    export const Name = {
