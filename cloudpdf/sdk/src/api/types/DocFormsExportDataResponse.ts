...
export interface DocFormsExportDataResponse {
    name: DocFormsExportDataResponse.Name;
    code: DocFormsExportDataResponse.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocFormsExportDataResponse {
    export const Name = {
