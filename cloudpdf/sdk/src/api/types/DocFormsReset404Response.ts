...
export interface DocFormsReset404Response {
    name: DocFormsReset404Response.Name;
    code: DocFormsReset404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocFormsReset404Response {
    export const Name = {
