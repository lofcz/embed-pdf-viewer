...
export interface DocPagesRotate400Response {
    name: DocPagesRotate400Response.Name;
    code: DocPagesRotate400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesRotate400Response {
    export const Name = {
