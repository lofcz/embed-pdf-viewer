...
export interface DocPagesInsertBlank400Response {
    name: DocPagesInsertBlank400Response.Name;
    code: DocPagesInsertBlank400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesInsertBlank400Response {
    export const Name = {
