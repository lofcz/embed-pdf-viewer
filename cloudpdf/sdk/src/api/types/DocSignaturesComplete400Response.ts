...
export interface DocSignaturesComplete400Response {
    name: DocSignaturesComplete400Response.Name;
    code: DocSignaturesComplete400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesComplete400Response {
    export const Name = {
