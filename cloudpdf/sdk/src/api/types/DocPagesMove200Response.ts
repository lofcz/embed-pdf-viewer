...
export interface DocPagesMove200Response {
    meta: DocPagesMove200Response.Meta;
    /** Accepts any additional properties */
    [key: string]: any;
}

export namespace DocPagesMove200Response {
    ...
    export namespace Meta {
        ...
        export namespace AffectedPages {
            export interface Item {
                ...
                weakAnnotationState: CloudPDF.DocPagesMove200ResponseMetaAffectedPagesItemWeakAnnotationState;
            }
