...
export interface DocPagesInsertBlank404Response {
    name: DocPagesInsertBlank404Response.Name;
    code: DocPagesInsertBlank404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesInsertBlank404Response {
    export const Name = {
