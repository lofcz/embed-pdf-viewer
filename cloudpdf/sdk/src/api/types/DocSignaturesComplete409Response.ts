...
export interface DocSignaturesComplete409Response {
    name: DocSignaturesComplete409Response.Name;
    code: DocSignaturesComplete409Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesComplete409Response {
    export const Name = {
