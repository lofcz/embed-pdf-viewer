...
export interface DocSignaturesAnalysis404Response {
    name: DocSignaturesAnalysis404Response.Name;
    code: DocSignaturesAnalysis404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesAnalysis404Response {
    export const Name = {
