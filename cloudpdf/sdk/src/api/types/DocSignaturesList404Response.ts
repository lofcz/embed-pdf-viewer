...
export interface DocSignaturesList404Response {
    name: DocSignaturesList404Response.Name;
    code: DocSignaturesList404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesList404Response {
    export const Name = {
