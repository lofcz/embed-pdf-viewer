...
export interface DocPagesDelete200Response {
    meta: DocPagesDelete200Response.Meta;
    /** Accepts any additional properties */
    [key: string]: any;
}

export namespace DocPagesDelete200Response {
    ...
    export namespace Meta {
        ...
        export namespace AffectedPages {
            export interface Item {
                ...
                weakAnnotationState: CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationState;
            }
