...
export interface DocAnnotationsCreate404Response {
    name: DocAnnotationsCreate404Response.Name;
    code: DocAnnotationsCreate404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsCreate404Response {
    export const Name = {
