...
export interface DocMetadataGet404Response {
    name: DocMetadataGet404Response.Name;
    code: DocMetadataGet404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocMetadataGet404Response {
    export const Name = {
