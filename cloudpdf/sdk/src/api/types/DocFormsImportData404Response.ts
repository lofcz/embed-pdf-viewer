...
export interface DocFormsImportData404Response {
    name: DocFormsImportData404Response.Name;
    code: DocFormsImportData404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocFormsImportData404Response {
    export const Name = {
