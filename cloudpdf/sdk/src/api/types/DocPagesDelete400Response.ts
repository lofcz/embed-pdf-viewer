...
export interface DocPagesDelete400Response {
    name: DocPagesDelete400Response.Name;
    code: DocPagesDelete400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesDelete400Response {
    export const Name = {
