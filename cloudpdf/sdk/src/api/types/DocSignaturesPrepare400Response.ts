...
export interface DocSignaturesPrepare400Response {
    name: DocSignaturesPrepare400Response.Name;
    code: DocSignaturesPrepare400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesPrepare400Response {
    export const Name = {
