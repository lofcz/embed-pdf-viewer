...
export interface DocAnnotationsUpdate404Response {
    name: DocAnnotationsUpdate404Response.Name;
    code: DocAnnotationsUpdate404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsUpdate404Response {
    export const Name = {
