...
export interface DocAnnotationsDelete200Response {
    meta: DocAnnotationsDelete200Response.Meta;
    /** Accepts any additional properties */
    [key: string]: any;
}

export namespace DocAnnotationsDelete200Response {
    ...
    export namespace Meta {
        ...
        export namespace AffectedPages {
            export interface Item {
                ...
                weakAnnotationState: CloudPDF.DocAnnotationsDelete200ResponseMetaAffectedPagesItemWeakAnnotationState;
            }
