...
export interface DocSignaturesAbort404Response {
    name: DocSignaturesAbort404Response.Name;
    code: DocSignaturesAbort404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesAbort404Response {
    export const Name = {
