...
export interface DocPagesRotate200Response {
    meta: DocPagesRotate200Response.Meta;
    /** Accepts any additional properties */
    [key: string]: any;
}

export namespace DocPagesRotate200Response {
    ...
    export namespace Meta {
        ...
        export namespace AffectedPages {
            export interface Item {
                ...
                weakAnnotationState: CloudPDF.DocPagesRotate200ResponseMetaAffectedPagesItemWeakAnnotationState;
            }
