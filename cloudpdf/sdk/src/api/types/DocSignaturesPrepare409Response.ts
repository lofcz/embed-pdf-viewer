...
export interface DocSignaturesPrepare409Response {
    name: DocSignaturesPrepare409Response.Name;
    code: DocSignaturesPrepare409Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesPrepare409Response {
    export const Name = {
