...
export interface DocAnnotationsDelete404Response {
    name: DocAnnotationsDelete404Response.Name;
    code: DocAnnotationsDelete404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsDelete404Response {
    export const Name = {
