...
export interface DocFormsSetValue404Response {
    name: DocFormsSetValue404Response.Name;
    code: DocFormsSetValue404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocFormsSetValue404Response {
    export const Name = {
