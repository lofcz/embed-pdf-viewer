...
export interface DocSignaturesAnalysis400Response {
    name: DocSignaturesAnalysis400Response.Name;
    code: DocSignaturesAnalysis400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocSignaturesAnalysis400Response {
    export const Name = {
