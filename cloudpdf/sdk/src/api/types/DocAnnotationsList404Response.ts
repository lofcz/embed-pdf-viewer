...
export interface DocAnnotationsList404Response {
    name: DocAnnotationsList404Response.Name;
    code: DocAnnotationsList404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsList404Response {
    export const Name = {
