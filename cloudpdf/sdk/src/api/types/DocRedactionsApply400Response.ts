...
export interface DocRedactionsApply400Response {
    name: DocRedactionsApply400Response.Name;
    code: DocRedactionsApply400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocRedactionsApply400Response {
    export const Name = {
