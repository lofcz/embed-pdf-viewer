...
export interface DocAnnotationsUpdate400Response {
    name: DocAnnotationsUpdate400Response.Name;
    code: DocAnnotationsUpdate400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsUpdate400Response {
    export const Name = {
