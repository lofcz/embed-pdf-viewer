...
export interface DocVersionsSignatureContentsResponse {
    name: DocVersionsSignatureContentsResponse.Name;
    code: DocVersionsSignatureContentsResponse.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsSignatureContentsResponse {
    export const Name = {
