...
export interface DocFormsSetValue400Response {
    name: DocFormsSetValue400Response.Name;
    code: DocFormsSetValue400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocFormsSetValue400Response {
    export const Name = {
