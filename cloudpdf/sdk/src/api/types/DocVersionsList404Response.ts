...
export interface DocVersionsList404Response {
    name: DocVersionsList404Response.Name;
    code: DocVersionsList404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsList404Response {
    export const Name = {
