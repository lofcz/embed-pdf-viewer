...
export interface DocVersionsAnalysis404Response {
    name: DocVersionsAnalysis404Response.Name;
    code: DocVersionsAnalysis404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocVersionsAnalysis404Response {
    export const Name = {
