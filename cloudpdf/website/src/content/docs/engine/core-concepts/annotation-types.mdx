...
document carries). See [Custom fonts](/docs/engine/core-concepts/custom-fonts).
...
- **Single-page PDF** — cloned in as a _vector_ appearance that stays crisp at any zoom.
