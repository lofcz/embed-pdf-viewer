...
export const brazilianPortugueseTranslations: Locale = {
  code: 'pt-BR',
  ...
  translations: {
    ...
    zoom: {
      ...
      marquee: 'Zoom por área',
      menu: 'Menu de zoom',
      level: 'Nível de zoom ({level}%)',
      dragTip: 'Arraste para selecionar a área de zoom',
    },
    pan: {
      toggle: 'Alternar modo de arrastar',
    },
    pointer: {
      toggle: 'Alternar modo de ponteiro',
    },
    capture: {
      screenshot: 'Captura de tela',
      dragTip: 'Arraste para selecionar a área a capturar',
      title: 'Pré-visualização da captura',
      download: 'Baixar',
      cancel: 'Cancelar',
    },
    document: {
      menu: 'Menu do documento',
      open: 'Abrir',
      close: 'Fechar',
      print: 'Imprimir',
      protect: 'Segurança',
    ...
    emptyState: {
      ...
      description: 'Abra um documento PDF para começar.',
      descriptionMulti: 'Você pode visualizar vários documentos usando abas.',
      openButton: 'Abrir documento',
      supportedFormats: 'Formato suportado: PDF',
    },
    passwordPrompt: {
      title: 'Senha necessária',
      required: 'Este documento está protegido por senha. Digite a senha para abri-lo.',
      incorrect: 'A senha digitada está incorreta. Tente novamente.',
      incorrectWarning: 'Senha incorreta. Verifique e tente novamente.',
      label: 'Senha',
    ...
    panel: {
      ...
      thumbnails: 'Miniaturas',
      outline: 'Sumário',
      annotationStyle: 'Estilo de anotação',
      redaction: 'Barra lateral de redação',
    },
    menu: {
    ...
    outline: {
      ...
      noBookmarks: 'Este documento não contém marcadores',
    },
    page: {
      settings: 'Configurações da página',
      single: 'Página única',
      twoOdd: 'Duas páginas (ímpares)',
      twoEven: 'Duas páginas (pares)',
      vertical: 'Vertical',
      horizontal: 'Horizontal',
      spreadMode: 'Modo de páginas espelhadas',
      scrollLayout: 'Layout de rolagem',
      rotation: 'Rotação da página',
      next: 'Próxima página',
      previous: 'Página anterior',
    },
    rotate: {
    ...
    annotation: {
      ...
      polyline: 'Polilinha',
      ink: 'Tinta',
      inkHighlighter: 'Marca-texto de tinta',
      stamp: 'Carimbo',
      caret: 'Cursor de inserção',
      insertText: 'Inserir texto',
      replaceText: 'Substituir texto',
      freeText: 'Texto livre',
      square: 'Quadrado',
      style: 'Estilo de anotação',
      styles: 'Estilos de {type}',
      ...
      lineEnding: 'Extremidade da linha',
      lineStart: 'Início da linha',
      lineEnd: 'Fim da linha',
      font: 'Fonte',
      fontColor: 'Cor da fonte',
      backgroundColor: 'Cor de fundo',
      noStyles: 'Não há estilos para esta anotação.',
      noStylesStamp: 'Não há estilos para carimbos.',
      selectAnnotation: 'Selecione uma anotação para ver seus estilos',
      deleteSelected: 'Excluir anotação selecionada',
      deleteAllSelected: 'Excluir selecionadas',
      multiSelect: '{count} anotações selecionadas',
      group: 'Agrupar',
      ungroup: 'Desagrupar',
      moreTools: 'Mais ferramentas',
      addLink: 'Adicionar link',
      removeLink: 'Remover link',
      gotoLink: 'Ir para link',
      comment: 'Comentário',
      callout: 'Chamada',
      redact: 'Redigir',
      overlayText: 'Texto sobreposto',
      overlayTextPlaceholder: 'ex.: REDIGIDO',
      rotation: 'Rotação',
    },
    insert: {
      image: 'Imagem',
    ...
    redaction: {
      redact: 'Redigir',
      area: 'Área de redação',
      text: 'Redigir texto',
      apply: 'Aplicar redação',
      applyAll: 'Aplicar tudo',
      clearAll: 'Limpar tudo',
      deleteSelected: 'Excluir redação selecionada',
      commitSelected: 'Aplicar redação selecionada',
      emptyState: 'Nenhuma redação pendente',
      panel: {
        title: 'Redações',
        itemCount: '{count} redação pendente',
        itemCountPlural: '{count} redações pendentes',
        clearAll: 'Limpar tudo',
        redactAll: 'Redigir tudo',
      },
    },
    history: {
      undo: 'Desfazer',
    ...
    comments: {
      ...
      showMore: 'mais',
      showLess: 'menos',
      emptyState: 'Adicione anotações para poder comentá-las.',
    },
    blendMode: {
      normal: 'Normal',
      multiply: 'Multiplicar',
      ...
      darken: 'Escurecer',
      lighten: 'Clarear',
      colorDodge: 'Subexposição de cores',
      colorBurn: 'Superexposição de cores',
    ...
    print: {
      ...
      specify: 'Especificar páginas',
      specifyEG: 'ex.: 1-3, 5, 8-10',
      total: 'Total de páginas no documento: {totalPages}',
    ...
    protect: {
      title: 'Proteger documento',
      cancel: 'Cancelar',
      apply: 'Aplicar proteção',
      applying: 'Aplicando...',
      applyFailed: 'Falha ao aplicar proteção. Tente novamente.',
      removeFailed: 'Falha ao remover proteção. Tente novamente.',
      passwordMismatch: 'As senhas não coincidem',
      noProtectionSelected: 'Selecione pelo menos uma opção de proteção para aplicar.',
      bothPasswordsNote:
        'Usuários que abrirem com a senha do documento terão permissões restritas. Use a senha de proprietário para liberar o acesso completo.',
      openPassword: {
        title: 'Exigir senha para abrir',
        description: 'Os usuários precisarão digitar uma senha para visualizar este documento.',
        label: 'Senha do documento',
      ...
      ownerPassword: {
        ...
        placeholder: 'Digite a senha de proprietário',
        confirm: 'Confirmar senha de proprietário',
        confirmPlaceholder: 'Confirme a senha de proprietário',
      },
      permissions: {
        title: 'Restringir permissões',
        description: 'Limite o que os usuários podem fazer com este documento.',
        allowedActions: 'Ações permitidas',
        print: 'Imprimir',
        printHighQuality: 'Imprimir em alta qualidade',
        copy: 'Copiar conteúdo',
        accessibility: 'Extrair para acessibilidade',
        modify: 'Modificar conteúdo',
        annotations: 'Adicionar/modificar anotações e comentários',
        fillForms: 'Preencher formulários e assinar',
        assemble: 'Montar e extrair páginas',
      },
      encrypted: {
        title: 'O documento está protegido',
        description:
          'Este documento está protegido pelo proprietário. Digite a senha de proprietário para modificar as configurações de segurança.',
        enterOwnerPassword: 'Digite a senha de proprietário para modificar',
        unlockAndEdit: 'Desbloquear e editar',
      },
      modifyProtection: {
        title: 'Modificar proteção',
        description: 'Escolha como deseja modificar a proteção do documento.',
        changeOption: 'Alterar senhas ou permissões',
        changeDescription: 'Atualize a senha do documento ou as configurações de permissão.',
        removeOption: 'Remover toda a proteção',
        removeDescription: 'Remover a proteção por senha deste documento.',
      },
      removeProtection: {
        title: 'Remover proteção',
        warning: 'Tem certeza de que deseja remover a proteção?',
        description:
          'Isso removerá toda a proteção por senha do documento. Qualquer pessoa poderá abri-lo e modificá-lo.',
        confirm: 'Remover proteção',
      },
    },
    security: {
      protected: {
        title: 'Este documento está protegido',
        description:
          'Este arquivo está protegido e alguns recursos podem estar desativados. Acesse Segurança no menu do documento para visualizar ou desbloquear as permissões.',
        viewPermissions: 'Visualizar permissões',
      },
      viewPermissions: {
        title: 'Permissões do documento',
        description:
          'Este arquivo está restrito pelo proprietário e requer uma senha para desbloquear determinadas ações.',
        restrictedActions: 'Ações restritas',
      },
      unlock: {
        label: 'Digite a senha de proprietário para desbloquear o arquivo',
        placeholder: 'Digite a senha de proprietário',
        button: 'Desbloquear arquivo',
        invalidPassword: 'Senha inválida. Tente novamente.',
        failed: 'Falha ao desbloquear. Tente novamente.',
        success: 'Permissões de proprietário desbloqueadas! Você agora tem acesso completo.',
      },
    },
    common: {
      close: 'Fechar',
    ...
    stamp: {
      ...
      export: 'Exportar carimbos',
      emptyState: 'Nenhum carimbo encontrado na biblioteca selecionada.',
      createFromSelected: 'Criar carimbo',
      createFromGroup: 'Criar carimbo a partir de grupo',
      library: {
        custom: 'Carimbos personalizados',
      },
    },
    signature: {
      title: 'Assinaturas',
      createNew: 'Criar nova assinatura',
      createNewWithInitials: 'Criar assinatura e iniciais',
      placeSignature: 'Assinatura',
      placeInitials: 'Iniciais',
      remove: 'Remover assinatura',
      emptyState: 'Nenhuma assinatura ainda. Crie uma para começar.',
      create: {
        ...
        clear: 'Limpar',
        typePlaceholder: 'ex.: João da Silva',
        initialsPlaceholder: 'ex.: JS',
        uploadPlaceholder: 'Clique ou arraste uma imagem aqui',
        font: 'Fonte',
        color: 'Cor',
        cancel: 'Cancelar',
        save: 'Salvar',
